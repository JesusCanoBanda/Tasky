...
<body>
    <div class="results-table">
        ...
        <form class="player-form" action="{{ route('task.update', $tarea->id) }}" method="POST">
            ...
            <label>Nombre</label>
            <input type="text" name="nombre" value="{{ old('nombre', $tarea->nombre) }}" maxlength="18" required>
            ...
            <input type="text" maxlength="25" name="descripcion" value="{{ old('descripcion', $tarea->descripcion) }}" maxlength="50" required>
